...
ext_modules = [
    Extension(
        ...
        sources=[
            ...
            "_midynet/src/random_graph/prior/block_count.cpp",
            "_midynet/src/random_graph/prior/block.cpp",
            "_midynet/src/random_graph/prior/nested_block.cpp",
            "_midynet/src/random_graph/prior/edge_count.cpp",
            "_midynet/src/random_graph/prior/label_graph.cpp",
            "_midynet/src/random_graph/prior/nested_label_graph.cpp",
            "_midynet/src/random_graph/prior/degree.cpp",
            "_midynet/src/random_graph/prior/labeled_degree.cpp",
            "_midynet/src/random_graph/likelihood/likelihood.cpp",
            "_midynet/src/random_graph/likelihood/erdosrenyi.cpp",
            "_midynet/src/random_graph/likelihood/configuration.cpp",
            "_midynet/src/random_graph/likelihood/sbm.cpp",
            "_midynet/src/random_graph/likelihood/dcsbm.cpp",
            "_midynet/src/random_graph/util.cpp",
            "_midynet/src/random_graph/random_graph.cpp",
            "_midynet/src/random_graph/sbm.cpp",
            "_midynet/src/random_graph/dcsbm.cpp",
            "_midynet/src/data/data_model.cpp",
            "_midynet/src/data/dynamics/dynamics.cpp",
            "_midynet/src/data/dynamics/binary_dynamics.cpp",
            "_midynet/src/data/dynamics/cowan.cpp",
            "_midynet/src/data/dynamics/degree.cpp",
            "_midynet/src/data/dynamics/glauber.cpp",
            "_midynet/src/data/dynamics/sis.cpp",
            ...
            "_midynet/src/proposer/edge/util.cpp",
            "_midynet/src/proposer/edge/edge_proposer.cpp",
            "_midynet/src/proposer/edge/double_edge_swap.cpp",
            "_midynet/src/proposer/edge/hinge_flip.cpp",
            "_midynet/src/proposer/edge/single_edge.cpp",
