...
public:
        SISDynamics(RandomGraph& randomGraph, RNG& rng, double infectionProb, double recoveryProb=0.5, double autoInfectionProb=1e-6) :
            BinaryDynamics(randomGraph, rng), m_infectionProb(infectionProb), m_recoveryProb(recoveryProb), m_autoInfectionProb(autoInfectionProb)  { }
