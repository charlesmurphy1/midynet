...
class RandomGraphMCMCFactory(Factory):
    ...
    @staticmethod
    def build_sbm(config: RandomGraphConfig) -> mcmc.StochasticBlockGraphMCMC:
    ...
    @staticmethod
    def build_er(config: RandomGraphConfig) -> mcmc.RandomGraphMCMC:
        edge_proposer = EdgeProposerFactory.build(config.edge_proposer)
    ...
    @staticmethod
    def build_dcsbm(config: RandomGraphConfig) -> mcmc.StochasticBlockGraphMCMC:
        return RandomGraphMCMCFactory.build_sbm(config)

    @staticmethod
    def build_cm(config: RandomGraphConfig) -> mcmc.RandomGraphMCMC:
